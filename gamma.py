...
cv2.createTrackbar("gamma", "config", 1, 10, lambda x: None)
cv2.createTrackbar("gain", "config", 1, 10, lambda x: None)
cv2.createTrackbar("scale", "config", 200, 255, lambda x: None)
